...
//#endif
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//glUniform4f(colorLoc, 0.2f, 0.0f, 0.2f, 1.0f); //enviando cor para variável uniform inputColor

		// Chamada de desenho - drawcall
		// Poligono Preenchido - GL_TRIANGLES
		glDrawArrays(GL_TRIANGLES, 0, 6); //Exercício 5 (letra a)
		//glDrawArrays(GL_TRIANGLES, 0, 24); //Exercício 9

        // Contorno do polígono - GL_LINE_LOOP
		//glUniform4f(colorLoc, 0.5f, 0.0f, 0.2f, 1.0f); //Exercício 5 (letra d)
		//glUniform4f(colorLoc, 0.5f, 0.28f, 0.0f, 1.0f); //Exercício 9
		//glDrawArrays(GL_LINE_LOOP, 0, 3); //Exercício 5 (letra b e d)
		//glDrawArrays(GL_LINE_LOOP, 3, 3); //Exercício 5 (letra b e d)
		//glDrawArrays(GL_LINE_STRIP, 24, 3); //Exercício 9
		//glDrawArrays(GL_LINE_STRIP, 27, 2); //Exercício 9
		//glDrawArrays(GL_LINE_STRIP, 29, 3); //Exercício 9
		//glDrawArrays(GL_LINE_STRIP, 32, 2); //Exercício 9

        // Desenho dos pontos - GL_POINTS
		//glUniform4f(colorLoc, 0.0f, 0.0f, 0.5f, 1.0f); //Exercício 5 (letra d)
...
int exercicio8()
{
	...
	GLfloat vertices[] = {
		...
		-0.5,  0.5, 0.0, 1.0, 0.0, 0.0, //v0 vermelho
		 ...
		 0.5,  0.5, 0.0, 0.2, 0.0, 0.0, //v3 vermelho escuro
		-0.5, -0.5, 0.0, 0.0, 0.2, 0.0, //v4 verde escuro
 		 0.5, -0.5, 0.0, 0.0, 0.0, 0.2, //v5 azul escuro
	};
