...
int triangulo()
{
	...
	GLfloat vertices[] = {
		//x    y    z    r    g    b
		-80.0,  80.0, 0.0, 1.0, 0.0, 0.0, //v0 vermelho
		 80.0,  80.0, 0.0, 0.0, 1.0, 0.0, //v1 verde
 		-80.0, -80.0, 0.0, 0.0, 0.0, 1.0, //v2 azul
		 80.0,  80.0, 0.0, 0.2, 0.0, 0.0, //v3 vermelho escuro
		-80.0, -80.0, 0.0, 0.0, 0.2, 0.0, //v4 verde escuro
 		 80.0, -80.0, 0.0, 0.0, 0.0, 0.2, //v5 azul escuro
	};
